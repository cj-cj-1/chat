<template>
 ...
 <view class="btn-item reset-btn" v-show="showResetBtn" @tap="init"></view>
        ...
        <view class="uni-info__ft">
            <view class="uni-modal__btn uni-modal__btn_default" style="color: rgb(0, 0, 0); border-radius: 48rpx;" @tap="cancel">取消</view>
            <view class="uni-modal__btn uni-modal__btn_primary" style="color: rgb(0, 122, 255); border-radius: 48rpx;" @tap="confirm">确定</view>
        </view>
    </view>
</template>
